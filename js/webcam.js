            ...
            fetch(url, {
                    ...
                    .then(function(res){
                        if(res.status==200){
                            ...
                            window.location.replace(baseUrl+'/'+newPath+"/error.html");
                        }else if(res.status==5001){
                            window.location.replace(baseUrl+'/'+newPath+"/lowquality.html");
                            ...
                            window.location.replace(baseUrl+'/'+newPath+"/faceki-request-a-sign-in-pending.html");
                        }
                    }).catch(e=>{
                    console.log(e)
                })
